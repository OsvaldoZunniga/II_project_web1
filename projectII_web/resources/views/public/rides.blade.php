...
<head>
    ...
    <title>Rides Disponibles - AventonesCR</title>
                        ...
                        <form method="GET" action="{{ route('public.rides') }}">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 text-center">
                                    ...
                                    <a href="{{ route('public.rides') }}" class="btn btn-outline-light btn-lg px-4 ms-2" style="background:#27AE60;color:#fffde8;width:auto;min-width:180px;">
                                        Limpiar
                                    </a>
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            @else
                @foreach($rides as $ride)
                    @include('components.ride-card-public', ['ride' => $ride])
                @endforeach
            @endif
        </div>
    </div>
